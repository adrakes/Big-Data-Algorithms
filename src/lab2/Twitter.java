...
public class Twitter {
	...
	public static void main(String[] args)  {
		...
		Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/twitter","root", "didrik");
		//Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/twitter?useUnicode=yes&characterEncoding=UTF8&" + "user=root&password=didrik");
